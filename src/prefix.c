...
static short prefix_makecurr Args((THE_PPC *, short, line_t));
static short prefix_add Args((THE_PPC *, short, line_t));
static short prefix_duplicate Args((THE_PPC *, short, line_t));
static short prefix_copy Args((THE_PPC *, short, line_t));
static short prefix_move Args((THE_PPC *, short, line_t));
static short prefix_overlay Args((THE_PPC *, short, line_t));
static short prefix_lowercase Args((THE_PPC *, short, line_t));
static short prefix_uppercase Args((THE_PPC *, short, line_t));
static short prefix_delete Args((THE_PPC *, short, line_t));
static short prefix_point Args((THE_PPC *, short, line_t));
static short prefix_shift_left Args((THE_PPC *, short, length_t));
static short prefix_shift_right Args((THE_PPC *, short, length_t));
static short prefix_bounds_shift_left Args((THE_PPC *, short, length_t));
static short prefix_bounds_shift_right Args((THE_PPC *, short, length_t));
static short prefix_tabline Args((THE_PPC *, short, line_t));
static short prefix_scale Args((THE_PPC *, short, line_t));
static short prefix_show Args((THE_PPC *, short, line_t));
static short prefix_exclude Args((THE_PPC *, short, line_t));
static short prefix_block_duplicate Args((THE_PPC *, short, line_t));
static short prefix_block_copy Args((THE_PPC *, short, line_t));
static short prefix_block_move Args((THE_PPC *, short, line_t));
static short prefix_block_overlay Args((THE_PPC *, short, line_t));
static short prefix_block_lowercase Args((THE_PPC *, short, line_t));
static short prefix_block_uppercase Args((THE_PPC *, short, line_t));
static short prefix_block_delete Args((THE_PPC *, short, line_t));
static short prefix_block_shift_left Args((THE_PPC *, short, length_t));
static short prefix_block_shift_right Args((THE_PPC *, short, length_t));
static short prefix_block_bounds_shift_left Args((THE_PPC *, short, length_t));
static short prefix_block_bounds_shift_right Args((THE_PPC *, short, length_t));
static short prefix_block_exclude Args((THE_PPC *, short, line_t));
...
static void split_prefix_command Args((char_t *, THE_PPC *));
static short post_prefix_add Args((THE_PPC *, short, line_t));
