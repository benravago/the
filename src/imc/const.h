...
#define SAY       -128          // The various tokens - in the same order as in words[]
#define SAYN      -127
#define DO        -126
#define END       -125
#define IF        -124
...
#define OPnot    26             //  '\' (backslash)  /* TODO: maybe use '~' or '!' instead */
...
typedef struct _funcinfo {      // Structure containing info about a function
  ...
  int (*dlfunc)(char*,int);              // Address of the function
