...
/* Functions related to QUERY,STATUS and EXTRACT - A-L */
...
extern char_t query_num1[50];
extern char_t query_num2[50];
extern char_t query_num3[50];
extern char_t query_num4[50];
extern char_t query_num5[50];
extern char_t query_num6[50];
extern char_t query_num7[50];
extern char_t query_num8[50];
...
short extract_fdisplay(short number_variables, short itemno, char_t *itemargs, char_t query_type, line_t argc, char_t *arg, line_t arglen) {
  item_values[1].value = (char_t *) CURRENT_FILE->display_name;
