...
extern char *profile_command_line, *target_buffer;
...
extern char *the_version, *the_release, *the_copyright, term_name[20];
extern char *tempfilename;
extern short colour_offset_bits;
extern char user_home_dir[MAX_FILE_NAME + 1];
extern char *rexxoutname, *keyfilename, rexx_pathname[MAX_FILE_NAME + 1], rexx_filename[10], *dirfilename;
extern char macro_suffix[12];
extern char dir_pathname[MAX_FILE_NAME + 1], dir_filename[10], key_pathname[MAX_FILE_NAME + 1], key_filename[15];
...
extern char fifo_name[MAX_FILE_NAME + 1];
extern char pid_name[MAX_FILE_NAME + 1];
