...
COMMAND command[] = {
  ...
  { (char_t *) "span", 4, (-1), Span, TRUE, TRUE, FALSE, TRUE, FALSE, STRIP_BOTH, FALSE, FALSE, TRUE, CUA_RESET_BLOCK, THIGHLIGHT_NONE, (char_t *) "" },    /* commset2.c */
  { (char_t *) "spill", 5, (-1), Spill, TRUE, TRUE, FALSE, TRUE, FALSE, STRIP_BOTH, FALSE, FALSE, TRUE, CUA_RESET_BLOCK, THIGHLIGHT_NONE, (char_t *) "" },  /* commset2.c */
