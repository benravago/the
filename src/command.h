...
/*
$Id: command.h,v 1.25 2016/12/24 05:46:29 mark Exp $
*/
/*
...
COMMAND command[] = {
  ...
  { (CHARTYPE *) "errorformat", 6, (-1), Errorformat, TRUE, TRUE, FALSE, TRUE, FALSE, STRIP_BOTH, FALSE, FALSE, TRUE, CUA_RESET_BLOCK, THIGHLIGHT_NONE, (CHARTYPE *) "" },      /* commset1.c */
  { (CHARTYPE *) "erroroutput", 8, (-1), Erroroutput, TRUE, TRUE, FALSE, TRUE, FALSE, STRIP_BOTH, FALSE, FALSE, TRUE, CUA_RESET_BLOCK, THIGHLIGHT_NONE, (CHARTYPE *) "" },      /* commset1.c */
