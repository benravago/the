...
static char RCSid[] = "$Id: memory.c,v 1.1 1999/06/25 06:11:56 mark Exp mark $";
 ...
 * tend to use lots of small size memory. If you #define THE_TRACEMEM,
 ...
 *
 * The tracing part of this file, (#ifdef THE_TRACEMEM) is an optional
 ...
 * if needed.
 *
 * An additional option to THE_TRACEMEM is filling allocated and deallocated
 ...
 *
 * NOTE that #define'ing THE_TRACEMEM requires that your machine follows
 ...
 */
static char *theflists[sizeof(sizes)/sizeof(int)] = { NULL } ;
...
/******************************************************************************/
{
   ...
   if (sizeof(int)>4 || sizeof(int*)>4)
      hash[3] = 2 ;
   memset( theflists, 0, ( sizeof(sizes) / sizeof(int) ) * sizeof(char *) );
