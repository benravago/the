...
char_t *get_key_definition (int, int, bool, bool);
...
char_t *get_next_command (short, int);
...
short execute_set_sos_command (bool, char_t *);
...
short execute_locate (char_t *, bool, bool, bool *);
...
short parse_target (char_t *, line_t, TARGET *, long, bool, bool, bool);
void initialise_target (TARGET *);
void free_target (TARGET *);
short find_target (TARGET *, line_t, bool, bool);
short find_column_target (char_t *, length_t, TARGET *, length_t, bool, bool);
...
short execute_change_case (char_t *, char_t);
...
short execute_put (char_t *, bool);
short execute_macro (char_t *, bool, short *);
...
short execute_expand_compress (char_t *, bool, bool, bool, bool);
...
char_t *new_filename (char_t *, char_t *, char_t *, char_t *);
...
char **StringToArgv (int *, char *);
                                                             ...
                                                             /* util.c */
char_t *ebc2asc (char_t *, int, int, int);
...
short get_word (char_t *, length_t, length_t, length_t *, length_t *);
...
PARSER_DETAILS *parserll_find (PARSER_DETAILS *, char_t *);
...
PARSER_MAPPING *mappingll_find (PARSER_MAPPING *, char_t *, char_t *);
...
PARSE_COMMENTS *parse_commentsll_find (PARSE_COMMENTS *, char_t *);
...
char *get_rexx_interpreter_version (char *);
                                                           ...
                                                           /* os2eas.c */
                                                            /* query.c */
short find_query_item (char_t *, int, char_t *);
...
short THEcursor_down (char_t, VIEW_DETAILS *, short);
short THEcursor_file (bool, line_t, length_t);
short THEcursor_home (char_t, VIEW_DETAILS *, bool);
short THEcursor_left (short, bool);
short THEcursor_right (short, bool);
short THEcursor_up (short);
short THEcursor_move (char_t, VIEW_DETAILS *, bool, bool, short, short);
...
short All (char_t *);
short Alt (char_t *);
short Arbchar (char_t *);
short Autocolour (char_t *);
short Autosave (char_t *);
short Autoscroll (char_t *);
short Backup (char_t *);
short Backward (char_t *);
short BeepSound (char_t *);
short Bottom (char_t *);
...
short Cfirst (char_t *);
short Change (char_t *);
short Cinsert (char_t *);
short Clast (char_t *);
short THEClipboard (char_t *);
short Clearerrorkey (char_t *);
short Clearscreen (char_t *);
short Clocate (char_t *);
short Clock (char_t *);
short Cmatch (char_t *);
short Cmdarrows (char_t *);
short Cmdline (char_t *);
short Cmsg (char_t *);
short Colour (char_t *);
short Colouring (char_t *);
short Compat (char_t *);
short Compress (char_t *);
short THECommand (char_t *);
short ControlChar (char_t *);
short Copy (char_t *);
short Coverlay (char_t *);
short Creplace (char_t *);
short Ctlchar (char_t *);
...
short Dialog (char_t *);
short Directory (char_t *);
short Display (char_t *);
short Duplicate (char_t *);
short Ecolour (char_t *);
short Emsg (char_t *);
short THEEditv (char_t *);
short Enter (char_t *);
short Eolout (char_t *);
...
short Ffile (char_t *);
short File (char_t *);
short THEFiletabs (char_t *);
short Fillbox (char_t *);
short Find (char_t *);
short Findup (char_t *);
short Fext (char_t *);
short Filename (char_t *);
short Fmode (char_t *);
short Fname (char_t *);
short Forward (char_t *);
short Fpath (char_t *);
short Fullfname (char_t *);
short Get (char_t *);
short THEHeader (char_t *);
short Help (char_t *);
short Hex (char_t *);
short Hexdisplay (char_t *);
short Hexshow (char_t *);
short Highlight (char_t *);
short Hit (char_t *);
short Idline (char_t *);
short Impmacro (char_t *);
short Impos (char_t *);
short Input (char_t *);
short Inputmode (char_t *);
short Insertmode (char_t *);
short THEInterface (char_t *);
short Join (char_t *);
short Lastop (char_t *);
short Left (char_t *);
short Lineflag (char_t *);
short Linend (char_t *);
short Locate (char_t *);
short Lowercase (char_t *);
short Macro (char_t *);
...
short Modify (char_t *);
short Mouse (char_t *);
short THEMove (char_t *);
short Msg (char_t *);
short Msgline (char_t *);
short Msgmode (char_t *);
short Newlines (char_t *);
short THENext (char_t *);
short Nextwindow (char_t *);
short Nfind (char_t *);
short Nfindup (char_t *);
short Nomsg (char_t *);
short Nondisp (char_t *);
short Nop (char_t *);
short Number (char_t *);
short Overlaybox (char_t *);
short Os (char_t *);
short Osnowait (char_t *);
short Osquiet (char_t *);
short Osredir (char_t *);
...
short Prefix (char_t *);
short Preserve (char_t *);
short Prevwindow (char_t *);
short Print (char_t *);
...
short Readv (char_t *);
short THERecord (char_t *);
short Recover (char_t *);
...
short Reset (char_t *);
short Restore (char_t *);
short Retrieve (char_t *);
short Rexxhalt (char_t *);
short Rexxoutput (char_t *);
short THERexx (char_t *);
short Rgtleft (char_t *);
short Right (char_t *);
short Save (char_t *);
short Scope (char_t *);
short Scale (char_t *);
short THESearch (char_t *);
short Select (char_t *);
short Set (char_t *);
short Schange (char_t *);
short Slk (char_t *);
short THEScreen (char_t *);
short Shadow (char_t *);
short Shift (char_t *);
short ShowKey (char_t *);
short Sort (char_t *);
short Sos (char_t *);
short Sos_addline (char_t *);
short Sos_blockend (char_t *);
short Sos_blockstart (char_t *);
short Sos_bottomedge (char_t *);
short Sos_cuadelback (char_t *);
short Sos_cuadelchar (char_t *);
short Sos_current (char_t *);
short do_Sos_current (char_t *, char_t, VIEW_DETAILS *);
...
short Sos_doprefix (char_t *);
short Sos_edit (char_t *);
short Sos_endchar (char_t *);
short Sos_execute (char_t *);
short Sos_firstchar (char_t *);
short Sos_firstcol (char_t *);
short Sos_instab (char_t *);
short Sos_lastcol (char_t *);
short Sos_leftedge (char_t *);
short Sos_makecurr (char_t *);
short Sos_marginl (char_t *);
short Sos_marginr (char_t *);
short Sos_pastecmdline (char_t *);
short Sos_parindent (char_t *);
short Sos_prefix (char_t *);
short do_Sos_prefix (char_t *, char_t, VIEW_DETAILS *);
short Sos_qcmnd (char_t *);
short Sos_rightedge (char_t *);
...
short Stay (char_t *);
short Suspend (char_t *);
short Synonym (char_t *);
short Tabfile (char_t *);
short Tabkey (char_t *);
