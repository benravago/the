...
static char RCSid[] = "$Id: query.c,v 1.2 1999/07/06 04:06:04 mark Exp mark $";
...
/***********************************************************************/
 QUERY_ITEM _THE_FAR query_item[] =
  {
   {(CHARTYPE *)"alt",             3, 3,ITEM_ALT,           2, 2,          LVL_FILE,QUERY_QUERY|QUERY_STATUS|QUERY_EXTRACT             ,extract_alt                    },
   ...
   {(CHARTYPE *)"ecolor",          6, 6,ITEM_ECOLOR,        2, ECOLOUR_MAX,LVL_VIEW,QUERY_QUERY|             QUERY_EXTRACT|QUERY_MODIFY,extract_ecolor                 },
   {(CHARTYPE *)"ecolour",         7, 7,ITEM_ECOLOUR,       2, ECOLOUR_MAX,LVL_VIEW,QUERY_QUERY|             QUERY_EXTRACT|QUERY_MODIFY,extract_ecolour                },
...
/*---------------------------------------------------------------------*/
 if (number_variables >= 0)
 {
    if (number_variables == 0)
    {
        ...
        */
       switch(query_item[itemno].item_number)
       {
          case ITEM_RING:
...
/***********************************************************************/
{
 return set_boolean_value((bool)(FOCUS_BOF),(short)1);
}
/***********************************************************************/
#ifdef HAVE_PROTO
...
/***********************************************************************/
{
 return set_boolean_value((bool)(FOCUS_TOF),(short)1);
}
/***********************************************************************/
#ifdef HAVE_PROTO
...
/***********************************************************************/
{
 return set_on_off_value(READONLYx,1);
}
/***********************************************************************/
#ifdef HAVE_PROTO
